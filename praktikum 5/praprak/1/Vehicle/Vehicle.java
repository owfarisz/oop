public abstract class Vehicle {
    ...
    public void displayInfo(Vehicle other) {
        System.out.println(this.brand + " " + this.model + " sedang balapan dengan " + other.brand + " " + other.model);
    }
    ...
    public void race(Vehicle opponent) {
        System.out.printf("%s (%s) balapan melawan %s (%s)\n", this.brand, this.getEnergySource(), opponent.brand, opponent.getEnergySource());
    }
}